      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 mb-3 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-mono px-2 py-0.2 rounded-full bg-rose-50 text-rose-700 border border-rose-200">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-32 sm:w-44 pl-7 pr-2.5 py-1 text-xs bg-slate-50 rounded-lg border border-slate-200 focus:outline-none focus:border-slate-400 transition-colors placeholder:text-slate-400 text-slate-700"
          />
        </div>
      </div>
            ...
            {filtered.length === 0 ? (
              ...
              filtered.slice(0, 10).map((inv) => {
                ...
                return (
                  ...
                  >
                    <td className="py-2.5 pl-1 font-mono font-medium text-slate-900">
                    ...
                    <td className="py-2.5 text-center font-mono">
                      <span className="inline-block px-1.5 py-0.2 rounded text-[11px] font-medium bg-rose-50 text-rose-700">
                        {days > 0 ? `${days}d past due` : "Due today"}
                      </span>
                    </td>
                    <td className="py-2.5 pr-1 text-right font-mono font-semibold text-rose-600">
                      {formatCurrency(amt)}
                    </td>
                  </tr>
                );
